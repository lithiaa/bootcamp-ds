...
describe("Login Test", () => {
  ...
  it("should login successfully with valid credentials", async () => {
    ...
    await screenshotAction.fullPageScreenshot("login_success");
  });
  ...
  it("should show error message with invalid username", async () => {
    ...
    await screenshotAction.fullPageScreenshot("login_error_invalid_username");
  });
  ...
  it("should show error message with invalid password", async () => {
    ...
    await screenshotAction.fullPageScreenshot("login_error_invalid_password");
  });
  ...
  it("Login with locked_out_user", async () => {
    ...
    await screenshotAction.fullPageScreenshot("login_error_locked_user");
  });
});
